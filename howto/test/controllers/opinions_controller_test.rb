...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { desc_text: @opinion.desc_text, header_text: @opinion.header_text, link_url: @opinion.link_url } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { desc_text: @opinion.desc_text, header_text: @opinion.header_text, link_url: @opinion.link_url } }
